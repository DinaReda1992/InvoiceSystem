			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/userImage.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">فوترها</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices/paidInvoices') }}">الفواتير المدفوعة</a></li>
                            @endcan
                            @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices/PartiallyPaidInvoices') }}">الفواتير المدفوعة جزئيا</a></li>
                            @endcan
                            @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices/unPaidInvoices') }}">الفواتير الغير مدفوعة</a></li>
							@endcan
                            @can('أرشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . $page='invoices/indexArchived') }}">  الأرشيف</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('تقرير الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices/invoices_report') }}">تقارير الفواتير</a></li>
                            @endcan
                            @can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices/customers_report') }}">تقارير العملاء</a></li>
                            @endcan
                        </ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('الأقسام')
							<li><a class="slide-item" href="{{ url('/' . $page='sections/index') }}">  الأقسام</a></li>
                            @endcan
                            @can('المنتجات')
							<li><a class="slide-item" href="{{ url('/' . $page='items/index') }}">   المنتجات</a></li>
                            @endcan
                        </ul>
					</li>
                    @endcan
