            ...
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <form method="post" action={{ route('sections.store') }}>
                        @csrf
                        <h6 class="modal-title">إضافة قسـم</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="section_name">اسم القـسم</label>
                        <input class="form-control" id="section_name" name="section_name" required>
                    </div>
                    <div class="form-group">
                        <label for="description">وصـف</label>
                ...
                <div class="modal-body">
                    <form action="{{ route('sections.update', $section->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="section_name" name="section_name" autocomplete>
                        </div>
                        <div class="form-group">
                            <label for="description" class="col-form-label">وصف:</label>
