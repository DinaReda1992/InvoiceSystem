            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <button type="button" class="button btn btn-primary x-small" data-toggle="modal"
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="modal-effect btn btn-sm btn-info" data-id="{{ $product->id }}"
                                                data-item_name="{{ $product->item_name }}"
                                                data-section_name="{{ $product->section->section_name }}"
                                                data-description="{{ $product->description }}" data-toggle="modal"
                                                data-target="#edit_Product"><i class="las la-pen"></i>
                                            </button>
                                            <button class="modal-effect btn btn-sm btn-danger "
                                                data-id="{{ $product->id }}" data-item_name="{{ $product->item_name }}"
                                                data-toggle="modal" data-target="#modaldemo9">
